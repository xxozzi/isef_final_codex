...
\author{%
    Ishaan Gulrajani and David Lopez-Paz\thanks{Alphabetical order, equal contribution.}\\
...
\begin{table}
    ...
    \begin{tabular}{lll}
        ...
        % transductive learning      & $L^1_1 U^1_1$ & $U^1_1$ \\
        \rowcolor{alternateRowColor}
...
\midrule
\multirow{11}{1.5cm}{Rotated MNIST}%
